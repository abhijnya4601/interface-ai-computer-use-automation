...
follow-on gaps this raised got real fixes, not caveats: **discovery-vs-replay domain separation** - every discovery turn sends page content to a third-party LLM, so `guardrail_check(phase=...)`
