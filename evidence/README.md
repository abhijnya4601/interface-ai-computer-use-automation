...
This directory has grown to 61 files across many discovery/replay/escalation runs made while
...
- **`discovery_run_*.jsonl`** (15 total) — every real discovery run made during this build,
  across all 5 capabilities in `../capabilities/` plus throwaway/edge-case probes.
- **`replay_*.json`** (19) — every real replay result, across success/business-outcome/
